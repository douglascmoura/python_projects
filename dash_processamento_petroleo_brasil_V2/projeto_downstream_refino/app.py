...
# Utilizamos o tema BOOTSTRAP (neutro) como base de reset CSS e tipografia,
# compatível com o tema claro (light) da aplicação.
app = dash.Dash(
    __name__,
...
# (como NumberInput e MultiSelect) apliquem corretamente seus estilos e scripts no modo claro.
